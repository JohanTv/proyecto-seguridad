...
export function LandingPage() {
  ...
  return (
            ...
            <section className="hero">
                <div className="container">
                    <div className="hero-inner">
	                        ...
	                        <h1 className="hero-title mt-0 is-revealing">MLJ - Password Manager</h1>
	                        ...
	                        <div className="feature">
	                            <div className="feature-inner">
									<div className="feature-header mb-16">
		                                ...
		                                <h4 className="feature-title m-0">Store your passwords</h4>
									</div>
	                                <p className="text-sm mb-0">So that you don't have to remember them on your own, we store all your encrypted passwords on your local storage and show them back to you in a comprehensible way using the app and a personal Master Password</p>
	                            </div>
	                        </div>
							<div className="feature">
	                            <div className="feature-inner">
									<div className="feature-header mb-16">
		                                ...
		                                <h4 className="feature-title m-0">Generate new highly secure passwords</h4>
									</div>
	                                <p className="text-sm mb-0">Now that you don't need to keep all passwords in your head, you can have much longer, safer passwords. Even better, we can help you create them as secure at can be!</p>
	                            </div>
	                        </div>
							<div className="feature">
	                            <div className="feature-inner">
									<div className="feature-header mb-16">
		                                ...
		                                <h4 className="feature-title m-0">Get password security reports</h4>
									</div>
	                                <p className="text-sm mb-0">Once you got all your passwords stored, you can get a safety report for all of them when desired!</p>
	                            </div>
	                        </div>
						</div>
                    </div>
        ...
        <footer className="site-footer">
            ...
            <div className="container">
                <div className="site-footer-inner has-top-divider">
                    <div className="footer-copyright">&copy; 2022 Password Manager, all rights reserved</div>
    ...
    <script src="../landing/main.min.js"></script>
</div>
    </Fragment>
  )
}
